     ...
     return (
        <div className='p-7 flex flex-col justify-center'>
            ...
            <form onSubmit={submitHandler}>
                ...
                <p className='text-center mb-[140px]'>New here? <Link  to='/captain-signup' className='text-blue-600'>Create New Account</Link></p>
            </div>
            <div>
                <Link
                to='/login'
                className='text-white font-semibold mb-7 rounded px-4 py-1 w-full text-lg bg-[#d5622d] flex items-center justify-center'
